...
%% Main folder
output_folder = fullfile('\\155.100.91.44\d\Code\Nill\Starling_neural_data\starling_7_spectogram_cue\');
...
for p = 1:numel(ptIDs)
   ...
   % reading task data:
    ...
    cardShow = eventTimes.cardShowTime;
    ...
    %     for tt = 1:nTrials
    %         % LFP around cardShow
    %         whichData = (cardShow(tt) - cardShowWindow):(cardShow(tt) + cardShowWindow - 1);
