...
main_folder = '\\155.100.91.44\d\Code\Nill\Starling_neural_data\starling_8_encoding_outcome_v1';
...
removeIdx = startsWith(regionNames, 'NAC', 'IgnoreCase', true);
brain_data = rmfield(brain_data, regionNames(removeIdx));
