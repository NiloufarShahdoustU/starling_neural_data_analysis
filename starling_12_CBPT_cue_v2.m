...
output_folder = fullfile('\\155.100.91.44\d\Code\Nill\Starling_neural_data\starling_12_CBPT_cue_v2\');
...
for p = 3:numel(files)
    ...
    for a = 1:numel(brainAreas)
        ...
        matName = fullfile(output_folder, ...
            sprintf('%s_%s_cue_anova_CBPT_results.mat', ...
            ptID, safeAreaName));
        ...
        sgtitle(sprintf('%s | %s | time-frequency cue spectrogram ANOVA CBPT', ...
            ptID, areaName), ...
            'FontWeight','bold', ...
            'Interpreter','none');
        ...
        pdfName = fullfile(output_folder, ...
            sprintf('%s_%s_uniform_low_high_anova_CBPT_spectrogram.pdf', ...
            ptID, safeAreaName));
